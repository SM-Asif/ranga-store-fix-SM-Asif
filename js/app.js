...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p><b>Rating:</b> ${product.rating.rate} (Rating Count: ${product.rating.count})</p>
...
const updatePrice = (id, value) => {
  ...
  document.getElementById(id).innerText = total.toFixed(2);// we could use also (Math.round((total + Number.EPSILON) * 100) / 100)
};
